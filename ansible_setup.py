...
class AnsibleSetup:
    ...
    def setup(self):
        ...
        generate ssh keys, install sshpass to automate the initial login and remove sshpass at the end
        """
        ...
        password_servers = getpass.getpass("Enter the ssh password for the servers you want to copy the key to: ")
    ...
    def install_sshpass(self, package_manager):
        ...
        """
        if package_manager == 'apt':
            os.system('sudo -S apt install sshpass -y')
        elif package_manager == 'pacman':
            os.system('sudo -S pacman -S sshpass --noconfirm --needed')
        elif package_manager == 'yum':
            os.system('sudo -S yum install sshpass -y')
    ...
    def uninstall_sshpass(self, package_manager):
        ...
        """
        if package_manager == 'apt':
            os.system('sudo -S apt remove sshpass -y')
            os.system('sudo -S apt autoremove -y')
        elif package_manager == 'pacman':
            os.system('sudo -S pacman -Rns sshpass --noconfirm')
        elif package_manager == 'yum':
            os.system('sudo -S yum autoremove sshpass -y')
